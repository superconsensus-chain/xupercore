...
type contractEventFilterFunc func(*blockFilter, *protos.ContractEvent) bool
...
func newBlockFilter(ori *protos.BlockFilter) (*blockFilter, error) {
...
func matchIterator(filter *blockFilter, tx *lpb.Transaction) bool {
	return matchString(filter.compiled.Initiator, tx.GetInitiator())
}

func matchAuthRequire(filter *blockFilter, tx *lpb.Transaction) bool {
...
func matchContractName(filter *blockFilter, tx *lpb.Transaction) bool {
...
func matchFromAddr(filter *blockFilter, tx *lpb.Transaction) bool {
...
func matchToAddr(filter *blockFilter, tx *lpb.Transaction) bool {
...
func matchEventName(filter *blockFilter, event *protos.ContractEvent) bool {
	return matchString(filter.compiled.EventName, event.GetName())
}

func matchTx(filter *blockFilter, tx *lpb.Transaction) bool {
...
func matchEvent(filter *blockFilter, event *protos.ContractEvent) bool {
